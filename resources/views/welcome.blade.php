@extends('layouts.app')
@section('content')
<button type="button" class="btn btn-modal centered" data-toggle="modal" data-target="#exampleModal">
    ფორმის გახსნა
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
            <div class="forma  col-12">
                ...
                <input type="text" id="sometext" name="sometext" class="form-control" placeholder="ფაილის სათაური" autocomplete="off">
                <button class="btn btn-getfile btn-modal col-12">
